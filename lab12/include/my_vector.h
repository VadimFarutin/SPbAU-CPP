...
void test_my_vector(T first, T second) {
	...
	my_vector<T> vector4, vector5;
	my_vector<T> vector6(vector4);
	
	vector4.push_back(first);
	vector4.push_back(second);
	vector5 = vector4;
	assert(vector5.size() == 2);
	assert(vector5.capacity() == 2);

	vector4 = vector6;
	assert(vector4.size() == 0);
	assert(vector4.capacity() == 1);
	assert(vector4 == vector6);

	vector4.resize(4);
	assert(vector4.size() == 4);
	...
	my_vector<T> vector7(0);
	assert(vector7.size() == 0);
	assert(vector7.capacity() == 1);
}